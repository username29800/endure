...
echo sprefix=\$\(echo \$entry $pchar grep ${sq}'^cfg_sprefix '$sq $pchar ${pos}2- $pchar $ln\) >> $1
echo pprefix=\$\(echo \$entry $pchar grep ${sq}'^cfg_pprefix '$sq $pchar ${pos}2- $pchar $ln\) >> $1
...
echo pkey=\$\(echo $dq\$csdb$dq $pchar grep ${sq}'^$pkeyformat$entryname '$sq $pchar ${pos}2- $pchar $ln\) >> $1
