...
echo '#!/bin/sh' > /home/$user/bin/safefox
echo 'export MOZ_FAKE_NO_SANDBOX=1' >> /home/$user/bin/safefox
echo 'firefox $1' >> /home/$user/bin/safefox
chmod 755 /home/$user/bin/safefox
echo '#!/bin/sh' > /home/$user/bin/showw
echo 'rofi -show window &' >> /home/$user/bin/showw
chmod 755 /home/$user/bin/showw
echo '#!/bin/sh' > /home/$user/bin/sdclock
echo 'xclock -digital -update 10 &' >> /home/$user/bin/sdclock
chmod 755 /home/$user/bin/sdclock
cp /utils/tlch /home/$user/bin/tlch
cp /utils/tlch /home/$user/bin/twrapper
cp /utils/tlch /home/$user/bin/tlaunch
...
chmod -R 755 /home/$user/build/ohmyzsh
sed -i 's,^.*zsh -l$,#&,' /home/$user/build/ohmyzsh/tools/install.sh
sh /home/$user/build/ohmyzsh/tools/install.sh
